angular.module("MasterDatabaseModule", ['ui.bootstrap', 'ProductConsumerService', 'ToastrNotification'])
        .controller("ProductConsumerController", ['$scope', 'productConsumerTable', 'toastrService',
            function ($scope, managementReportConsumer, toastrService) {
                ...
                $scope.loadTableRecords = function (yearmonth, page,procode) {
                    
                    $.ajax({
                        url: '/ManagementReport/ProductCerfiticateConsumedList/Checkitemexist',
                        type: 'post',
                        ...
                        success: function (response) {
                            if (!response) {
                                ...
                                if (ok) {
                                    ...
                                    managementReportConsumer.CalculateTableRecordsAsync(yearmonth,procode)
                                        .then(
                                            function(response) {
                ...
                $scope.Recalculate = function (yearmonth,procode) {
                ...
                $scope.confirmItemUpdate = function () {
                    ...
                    // TODO: Call ajax.
                    $.ajax({
                        url: '/ManagementReport/ProductCerfiticateConsumedList/UpdateManagementReport',
                        type: 'post',
                        data: {
                ...
                $scope.PrintItem = function (yearmonth) {
                    ...
                    if ($("#YearMonth").val() == "")
                        return;
                    $.ajax({
                        url: '/ManagementReport/ProductCerfiticateConsumedList/ExportConsumerMaterial',
                        type: 'post',
                ...
                $scope.reloaditem = function () {
                    ...
                    // Request loading data from service.
                    $scope.Recalculate($scope.selectedRow.YearMonthst, $scope.selectedRow.ProductCode);
                    $scope.cancelItemUpdate();
                    $scope.selectedRow = null;
                }
