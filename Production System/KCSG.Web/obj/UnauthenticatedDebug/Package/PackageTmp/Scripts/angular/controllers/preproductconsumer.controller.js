angular.module("MasterDatabaseModule", ['ui.bootstrap', 'PreProductConsumerService', 'ToastrNotification'])
        .controller("PreProductConsumerController", ['$scope', 'preProductConsumerTable', 'toastrService',
            function ($scope, managementReportConsumer, toastrService) {
                ...
                $scope.loadTableRecords = function (yearmonth,page,precode) {
                    $.ajax({
                        url: '/ManagementReport/PreProductReceivedConsumedList/Checkitemexist',
                        type: 'post',
                        ...
                        success: function (response) {
                            if (!response) {
                                ...
                                if (ok) {
                                    ...
                                    managementReportConsumer.CalculateTableRecordsAsync(yearmonth,precode)
                                        .then(
                                            function(response) {
                ...
                $scope.Recalculate = function (yearmonth,precode) {
                ...
                $scope.confirmItemUpdate = function () {
                    ...
                    // TODO: Call ajax.
                    $.ajax({
                        url: '/ManagementReport/PreProductReceivedConsumedList/UpdateManagementReport',
                        type: 'post',
                        data: {
                ...
                $scope.PrintItem = function (yearmonth) {
                    ...
                    if ($("#YearMonth").val() == "")
                        return;
                    $.ajax({
                        url: '/ManagementReport/PreProductReceivedConsumedList/ExportConsumerMaterial',
                        type: 'post',
                ...
                $scope.reloaditem = function () {
                    ...
                    // Request loading data from service.
                    $scope.Recalculate($scope.selectedRow.YearMonthst, $scope.selectedRow.PreProductCode);
                    $scope.cancelItemUpdate();
                    $scope.selectedRow = null;
                }
