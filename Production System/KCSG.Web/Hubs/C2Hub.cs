...
namespace KCSG.Web.Hubs
{
    ...
    [HubName("Communication-C2")]
    public class C2Hub : Hub
    {
        #region Properties
        ...
        public C2Hub()
        {
            ...
            Log = LogManager.GetLogger(typeof(C2Hub));
#endif
        }
        ...
        public override  Task OnConnected()
        {
            ...
            try
            {
                ...
                Log.Debug(
                    string.Format(
                        "(C2) IP : {0} - Terminal : {1} - Connection Index: {2} has connected. Await for checking...",
                ...
                if (realtimeConnection == null)
                {
                    ...
                    Log.Debug(string.Format("(C2) Initiate new connection record of terminal : {0}", Context.ConnectionId));
                }
