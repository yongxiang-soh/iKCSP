...
using KCSG.Web.Areas.EnvironmentManagement.ViewModels.CreepingAndRollSpeedDataEdit;
...
{
    [MvcAuthorize("TCEN075F")]
    public class CreepingAndRollSpeedDataEditController : KCSG.Web.Controllers.BaseController
    {
        private readonly ICreepingAndRollSpeedDataEditDomain _creepingAndRollSpeedDataEditDomain;
        private readonly IEnvironmentBaseDomain _environmentBaseDomain;

        #region Constructor

        public CreepingAndRollSpeedDataEditController(IEnvironmentBaseDomain environmentBaseDomain,
            ICreepingAndRollSpeedDataEditDomain creepingAndRollSpeedDataEditDomain)
        {
            _creepingAndRollSpeedDataEditDomain = creepingAndRollSpeedDataEditDomain;
        ...
        [HttpPost]
        public ActionResult Search(CreepingAndRollSpeedDataEditViewModel model)
        {
        ...
        [HttpPost]
        public ActionResult Edit(int id1, int id2, int id3, string environmentDate, string time, double leftCreeping,
            double rightCreeping, double rollSpeed)
        {
            try
            {
                var results = _creepingAndRollSpeedDataEditDomain.ChangeValueOfTime(environmentDate, time, id1, id2, id3);

                if (results.Item1 == null && results.Item2 == null && results.Item3 == null)
                {
                    return Json(new{Success=false});
                }
                _creepingAndRollSpeedDataEditDomain.Edit(id1, id2, id3, environmentDate, time, leftCreeping,
                    rightCreeping, rollSpeed);
        ...
        [HttpPost]
        public ActionResult ChangeValueOfTime(string environmentDate, string time, int id1, int id2, int id3)
        {
            var result = _creepingAndRollSpeedDataEditDomain.ChangeValueOfTime(environmentDate, time, id1, id2, id3);
            return Json(new
            {
                result.Item1,
                result.Item2,
