...
{
    [MvcAuthorize("TCFC105P")]
    public class PreProductMovementRecordController : KCSG.Web.Controllers.BaseController
    {
        ...
        public PreProductMovementRecordController(IManagementReportDomain ManagementReportDomain,
        ...
        public ActionResult Index()
        {
            ...
            return View(model);
                ...
                [HttpPost]
        public async Task<ActionResult> ExportPreProductMovementRecord(string from, string to)
        {
            try
            {                
                ...
                // check status
                    ...
                    var result =
                    await _ManagementReportDomain.SearchPreProductMovementRecord(from,to);
                    // Find the template file.
                    exportMaterialNameAbsolutePath =
                    Server.MapPath(string.Format("~/{0}", Constants.ExportTemplate.PreProductMovementRecord));
                    // Read the template.
