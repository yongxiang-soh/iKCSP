...
{
    [MvcAuthorize("TCFC106P")]
    public class ProductMovementHistoryController : KCSG.Web.Controllers.BaseController
    {
        ...
        public ProductMovementHistoryController(IManagementReportDomain ManagementReportDomain,
        ...
        public ActionResult Index()
        {
            ...
            return View(model);
                ...
                [HttpPost]
        public async Task<ActionResult> ExportProductMovementHistory(string from, string to)
        {
            try
            {                
                ...
                // check status
                    ...
                    var result =
                    await _ManagementReportDomain.SearchProductMovementHistory(from,to);
                    // Find the template file.
                    exportMaterialNameAbsolutePath =
                    Server.MapPath(string.Format("~/{0}", Constants.ExportTemplate.ProductMovementHistory));
                    // Read the template.
