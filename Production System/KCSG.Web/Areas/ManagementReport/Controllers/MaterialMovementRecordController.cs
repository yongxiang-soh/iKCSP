...
{
    [MvcAuthorize("TCFC104P")]
    public class MaterialMovementRecordController : KCSG.Web.Controllers.BaseController
    {
        ...
        public MaterialMovementRecordController(IManagementReportDomain ManagementReportDomain,
        ...
        public ActionResult Index()
        {
            ...
            return View(model);
                ...
                [HttpPost]
        public async Task<ActionResult> ExportMaterialMovementRecord(string from, string to)
        {
            try
            {                
                ...
                // check status
                    ...
                    var result =
                    await _ManagementReportDomain.SearchMaterialMovementRecord(from,to);
                    // Find the template file.
                    exportMaterialNameAbsolutePath =
                    Server.MapPath(string.Format("~/{0}", Constants.ExportTemplate.MaterialMovementRecord));
                    // Read the template.
