...
{
    [MvcAuthorize("TCFC151P")]
    public class ProductShippingRecordController : KCSG.Web.Controllers.BaseController
    {
        ...
        public ProductShippingRecordController(IManagementReportDomain ManagementReportDomain,
        ...
        public ActionResult Index()
        {
            ...
            return View(model);
                ...
                [HttpPost]
        public async Task<ActionResult> ExportProductShippingRecord(string from, string to)
        {
            try
            {                
                ...
                // check status
                    ...
                    var result =
                    await _ManagementReportDomain.SearchProductShippingRecord(from,to);
                    // Find the template file.
                    exportMaterialNameAbsolutePath =
                    Server.MapPath(string.Format("~/{0}", Constants.ExportTemplate.ProductShippingRecord));
                    // Read the template.
