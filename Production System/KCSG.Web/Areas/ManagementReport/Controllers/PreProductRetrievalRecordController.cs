...
{
    [MvcAuthorize(new []{ "TCFC121P", "TCSS017F" })]
    public class PreProductRetrievalRecordController : KCSG.Web.Controllers.BaseController
    {
        ...
        public PreProductRetrievalRecordController(IManagementReportDomain ManagementReportDomain,
