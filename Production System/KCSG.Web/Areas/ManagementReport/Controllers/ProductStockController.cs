...
{
    [MvcAuthorize("TCSS018F")]
    public class ProductStockController : KCSG.Web.Controllers.BaseController
    {
        ...
        public ProductStockController(IMaterialStockDomain MaterialStockDomain,
