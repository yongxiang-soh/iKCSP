...
{
    [MvcAuthorize("TCFC103P")]
    public class ProductMovementRecordController : KCSG.Web.Controllers.BaseController
    {
        ...
        public ProductMovementRecordController(IManagementReportDomain ManagementReportDomain,
        ...
        public ActionResult Index()
        {
            ...
            return View(model);
                ...
                [HttpPost]
        public async Task<ActionResult> ExportProductMovementRecord(string from, string to)
        {
            try
            {                
                ...
                // check status
                    ...
                    var result =
                    await _ManagementReportDomain.SearchProductMovementRecord(from,to);
                    // Find the template file.
                    exportMaterialNameAbsolutePath =
                    Server.MapPath(string.Format("~/{0}", Constants.ExportTemplate.ProductMovementRecord));
                    // Read the template.
