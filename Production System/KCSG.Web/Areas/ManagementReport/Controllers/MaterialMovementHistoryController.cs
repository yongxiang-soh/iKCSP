...
{
    [MvcAuthorize("TCFC101P")]
    public class MaterialMovementHistoryController : KCSG.Web.Controllers.BaseController
    {
        ...
        public MaterialMovementHistoryController(IManagementReportDomain ManagementReportDomain,
        ...
        public ActionResult Index()
        {
            ...
            return View(model);
                ...
                [HttpPost]
        public async Task<ActionResult> ExportMaterialMovementHistory(string from, string to)
        {
            try
            {                
                ...
                // check status
                    ...
                    var result =
                    await _ManagementReportDomain.SearchMaterialMovementHistory(from,to);
                    // Find the template file.
                    exportMaterialNameAbsolutePath =
                    Server.MapPath(string.Format("~/{0}", Constants.ExportTemplate.MaterialMovementHistory));
                    // Read the template.
